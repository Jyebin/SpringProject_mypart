...
public class NoticeDto {
    ...
    public NoticeDto(Long id, String title, String content, LocalDateTime regDate, LocalDateTime updateDate, int increaseCount,boolean deleted){
        this.id = id;
        this.regDate = regDate;
        this.updateDate = updateDate;
        this.title = title;
    ...
    public NoticeEntity ToEntity(){
        return new NoticeEntity(this.id, this.title, this.content,this.regDate, this.updateDate,0,false);
    }
